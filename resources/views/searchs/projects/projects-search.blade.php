...
<div class="projects-list">
    ...
    @php
    if($projects->count() <= 1){ $results='résultat' ; } else{ $results='résultats' ; } @endphp <h1 class="projects-list__title title"> {{$projects->count().' '.$results}} pour la recherche <strong>{{request()->q}}</strong></h1>
